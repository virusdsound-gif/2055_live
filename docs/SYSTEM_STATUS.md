...
**Mode:** Listening room first. Termux is not the door.

| Component | Status | Notes |
|-----------|--------|--------|
| Root | 0.7 Hz | In the rooms |
| Artist | KNG DRIZZ | Not a second identity |
...
| STAR / chain | Deferred | URI waits on X |

See `docs/TERMUX_CORRECTIONS.md` for the list of Termux lies that were pulled.
